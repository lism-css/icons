...
export type TagFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const TagFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, TagFillIconProps>(function TagFillIcon(
