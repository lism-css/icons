...
export type GoodFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const GoodFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, GoodFillIconProps>(function GoodFillIcon(
