...
export type HeartIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const HeartIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, HeartIconProps>(function HeartIcon(
