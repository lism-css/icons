...
export type BookmarkFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const BookmarkFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, BookmarkFillIconProps>(function BookmarkFillIcon(
