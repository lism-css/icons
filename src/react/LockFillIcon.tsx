...
export type LockFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const LockFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, LockFillIconProps>(function LockFillIcon(
