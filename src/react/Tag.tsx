...
export type TagProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const Tag = /* @__PURE__ */ forwardRef<SVGSVGElement, TagProps>(function Tag(
