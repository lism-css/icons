...
export type BanFillProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const BanFill = /* @__PURE__ */ forwardRef<SVGSVGElement, BanFillProps>(function BanFill(
