...
export type GoodIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const GoodIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, GoodIconProps>(function GoodIcon(
