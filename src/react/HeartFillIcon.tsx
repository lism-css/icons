...
export type HeartFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const HeartFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, HeartFillIconProps>(function HeartFillIcon(
