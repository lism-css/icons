...
export type UserFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const UserFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, UserFillIconProps>(function UserFillIcon(
