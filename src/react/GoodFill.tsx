...
export type GoodFillProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const GoodFill = /* @__PURE__ */ forwardRef<SVGSVGElement, GoodFillProps>(function GoodFill(
