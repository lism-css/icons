...
export type HomeFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const HomeFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, HomeFillIconProps>(function HomeFillIcon(
