...
export type LockFillProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const LockFill = /* @__PURE__ */ forwardRef<SVGSVGElement, LockFillProps>(function LockFill(
