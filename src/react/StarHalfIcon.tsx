...
export type StarHalfIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const StarHalfIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, StarHalfIconProps>(function StarHalfIcon(
  ...
  return (
    ...
    >
      <path
        d="M12,17.597c-.122,0-.241.03-.349.086l-4.772,2.509c-.253.133-.559.111-.79-.057s-.347-.452-.298-.734l.911-5.313c.042-.243-.039-.492-.216-.664l-3.86-3.763c-.204-.199-.278-.497-.19-.769s.323-.469.605-.51l5.335-.775c.244-.035.455-.189.565-.41l2.386-4.834c.126-.256.387-.418.673-.418v15.653Z"
        fill="currentColor"
        stroke="none"
      />
