...
export type NoteFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const NoteFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, NoteFillIconProps>(function NoteFillIcon(
