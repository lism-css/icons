...
export type BadFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const BadFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, BadFillIconProps>(function BadFillIcon(
