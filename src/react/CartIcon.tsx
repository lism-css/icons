...
export type CartIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const CartIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, CartIconProps>(function CartIcon(
