...
export type ChatFillProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const ChatFill = /* @__PURE__ */ forwardRef<SVGSVGElement, ChatFillProps>(function ChatFill(
