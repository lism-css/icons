...
export type CalendarFillIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const CalendarFillIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, CalendarFillIconProps>(function CalendarFillIcon(
