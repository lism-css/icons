...
export type StarHalfProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const StarHalf = /* @__PURE__ */ forwardRef<SVGSVGElement, StarHalfProps>(function StarHalf(
