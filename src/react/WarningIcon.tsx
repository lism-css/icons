...
export type WarningIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const WarningIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, WarningIconProps>(function WarningIcon(
