...
export type NoteIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const NoteIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, NoteIconProps>(function NoteIcon(
