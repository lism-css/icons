...
export type TagIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const TagIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, TagIconProps>(function TagIcon(
