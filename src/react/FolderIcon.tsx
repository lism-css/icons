...
export type FolderIconProps = SVGProps<SVGSVGElement> & { size?: number | string; weight?: 'light' | 'regular' | 'bold' };
const FolderIcon = /* @__PURE__ */ forwardRef<SVGSVGElement, FolderIconProps>(function FolderIcon(
